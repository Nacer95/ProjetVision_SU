 ...
 */
 ...
 // ------------------------------------------------------------------------
 {
     ...
     uint16 min3_gauche  = mot_max3(haut_gauche, milieu_gauche, bas_gauche);
     uint16 min3_milieu  = mot_max3(haut_milieu, milieu_milieu, bas_milieu);
 ...
 void line_max3_ui32matrix_swp_rotation(uint32 **X32, int i, int j0, int j1, uint32 **Y32)
 // ------------------------------------------------------------------------
 {
     //charger la bordure de gauche
     ...
     uint32 min3_gauche  = mot_max3(haut_gauche, milieu_gauche, bas_gauche);
     uint32 min3_milieu  = mot_max3(haut_milieu, milieu_milieu, bas_milieu);
 ...
 // -------------------------------------------------------------------------------
 {
     ...
     // displayR_ui8matrix (X8, i0, i1, j0, j1, "X8_mat");
     for(int i = i0; i<=i1; i++){
       line_max3_ui16matrix_swp_rotation(T16, i, j0, j1, Z16);
     }
 ...
 // -------------------------------------------------------------------------------
 {
   if (Y[0] == NULL)
     ...
     // displayR_ui8matrix (X8, i0, i1, j0, j1, "X8_mat");
     for(int i = i0; i<=i1; i++){
       line_max3_ui32matrix_swp_rotation(T32, i, j0, j1, Z32);
     }
